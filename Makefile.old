...
AVRDUDE_PROGRAMMER = nikolaew            # official name of 
...
AVRDUDE_FLAGS = -p $(MCU) -b 2400 -P $(AVRDUDE_PORT) -c $(AVRDUDE_PROGRAMMER)
...
#AVRDUDE_FLAGS +=  #keep chip disabled while cable attached
